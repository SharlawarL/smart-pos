    ...
    >
      ...
      <div className="relative bg-default-900 dark:bg-default-50 py-6">
        <div className="container flex flex-col text-center md:text-start md:flex-row gap-2">
          <p className="text-primary-foreground flex-1 text-base xl:text-lg font-medium">COPYRIGHT &copy; 2024 Smart POS All rights Reserved</p>
          <p className="text-primary-foreground flex-none text-base font-medium">
            Hand-crafted & Made by {" "}
            <Link href="#" target="__blank" className="text-primary hover:underline">Kool Elegance</Link></p>
        </div>
      </div>
    </footer>
  );
